...
class UFSReader(GriddedReader):
    def open_dataset(self,
        ...
        if var_list is not None:
            ...
            for var_sum in [
                "PM25", "PM10", "noy_gas", "noy_aer", "nox", "pm25_cl", "pm25_ec",
                "pm25_ca", "pm25_na", "pm25_nh4", "pm25_no3", "pm25_so4", "pm25_om",
            ]:
            ...
            needed = ["lat", "lon", "phalf", "tmp", "pressfc", "dpres", "hgtsfc", "delz"]
            var_list.extend(needed)

            # Remove standard names if present
            for vn in ["temperature_k", "surfpres_pa", "dp_pa", "surfalt_m", "dz_m", "pres_pa_mid"]:
                if vn in var_list:
                    var_list.remove(vn)
            ...
            pm25_vars = ["PM25_TOT", "PM25_TOT_NSOM", "PM25_EC", "PM25_NH4", "PM25_NO3", "PM25_SO4", "PM25_OC", "PM25_OM"]
            for v in pm25_vars:
                if v in var_list:
                    var_list.remove(v)
        else:
        ...
        # Standardize
        rename_dict = {
            "grid_yt": "y", "grid_xt": "x", "pfull": "z", "phalf": "z_i",
            "lon": "longitude", "lat": "latitude", "tmp": "temperature_k",
            "pressfc": "surfpres_pa", "dpres": "dp_pa", "hgtsfc": "surfalt_m", "delz": "dz_m",
        }
        ...
        # Lazy diagnostics
        if "PM25" in list_calc_sum: dset = add_lazy_pm25(dset, dict_sum)
        if "PM10" in list_calc_sum: dset = add_lazy_pm10(dset, dict_sum)
        if "noy_gas" in list_calc_sum: dset = add_lazy_noy_g(dset, dict_sum)
        if "noy_aer" in list_calc_sum: dset = add_lazy_noy_a(dset, dict_sum)
        if "nox" in list_calc_sum: dset = add_lazy_nox(dset, dict_sum)
...
def dict_species_sums(mech):
    if mech == "cb6r3_ae6_aq":
        ...
        sum_dict.update({
            "accumulation": [
                "aso4j", "ano3j", "anh4j", "anaj", "aclj", "aecj", "aothrj", "afej", "asij",
                "atij", "acaj", "amgj", "amnj", "aalj", "akj", "alvpo1j", "asvpo1j", "asvpo2j",
                "asvpo3j", "aivpo1j", "axyl1j", "axyl2j", "axyl3j", "atol1j", "atol2j", "atol3j",
                "abnz1j", "abnz2j", "abnz3j", "aiso1j", "aiso2j", "aiso3j", "atrp1j", "atrp2j",
                "asqtj", "aalk1j", "aalk2j", "apah1j", "apah2j", "apah3j", "aorgcj", "aolgbj",
                "aolgaj", "alvoo1j", "alvoo2j", "asvoo1j", "asvoo2j", "asvoo3j", "apcsoj",
            ]
        })
        sum_dict.update({
            "aitken": [
                "aso4i", "ano3i", "anh4i", "anai", "acli", "aeci", "aothri", "alvpo1i",
                "asvpo1i", "asvpo2i", "alvoo1i", "alvoo2i", "asvoo1i", "asvoo2i",
            ]
        })
        sum_dict.update({
        ...
        sum_dict.update({
            "noy_gas": [
                "no", "no2", "no3", "n2o5", "hono", "hno3", "pna", "cron", "clno2",
                "pan", "panx", "opan", "ntr1", "ntr2", "intr",
            ],
        ...
        sum_dict.update({"pm25_om": [
            "alvpo1i", "asvpo1i", "asvpo2i", "alvoo1i", "alvoo2i", "asvoo1i", "asvoo2i",
            "alvpo1j", "asvpo1j", "asvpo2j", "asvpo3j", "aivpo1j", "axyl1j", "axyl2j",
            "axyl3j", "atol1j", "atol2j", "atol3j", "abnz1j", "abnz2j", "abnz3j", "aiso1j",
            "aiso2j", "aiso3j", "atrp1j", "atrp2j", "asqtj", "aalk1j", "aalk2j", "apah1j",
            "apah2j", "apah3j", "aorgcj", "aolgbj", "aolgaj", "alvoo1j", "alvoo2j", "asvoo1j",
            "asvoo2j", "asvoo3j", "apcsoj",
        ]})
...
def add_lazy_pm25(d, dict_sum):
    ...
    weights = Series(concatenate([np.ones(len(dict_sum["aitken"])), np.ones(len(dict_sum["accumulation"])), np.full(len(dict_sum["coarse"]), 0.2)]))
