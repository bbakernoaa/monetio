...
class AQSReader(PointReader):
    def open_dataset(self,
        ...
        Reads AQS data.
        """
        # AQS class logic handles everything
        a = AQS()
        # If local is True, 'dates' might be filenames?
        # AQS add_data builds URLs from dates and params.
        # If we want to support 'files' argument as standard, we need to adapt.
        # But for backward compatibility with 'add_data' signature:
